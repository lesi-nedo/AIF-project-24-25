...
async def start_process(host:str , port: int, ai:str, a2: str ):
    gateway = Gateway(host, port)
    gateway.load_agent([ai, a2])
...
def main(
    ...
    typer.echo(f"Starting the process with host: {host}, port: {port}, ai1: {a1}, ai2: {a2}")
